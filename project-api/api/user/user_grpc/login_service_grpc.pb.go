...
type LoginServiceClient interface {
	GetCaptcha(ctx context.Context, in *CaptchaReq, opts ...grpc.CallOption) (*CaptchaResp, error)
...
func (c *loginServiceClient) GetCaptcha(ctx context.Context, in *CaptchaReq, opts ...grpc.CallOption) (*CaptchaResp, error) {
	out := new(CaptchaResp)
...
func (c *loginServiceClient) Register(ctx context.Context, in *RegisterReq, opts ...grpc.CallOption) (*RegisterResp, error) {
...
type LoginServiceServer interface {
	GetCaptcha(context.Context, *CaptchaReq) (*CaptchaResp, error)
